    ...
    <form action="{{ route('parcels.store') }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input type="text" name="parcel_type" value="{{ old('parcel_type') }}"
                       class="w-full border rounded-lg p-2" placeholder="e.g. Document, Box">
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select name="origin_branch_id" class="w-full border rounded-lg p-2">
            ...
            <div>
                ...
                <select name="destination_branch_id" class="w-full border rounded-lg p-2">
                    <option value="">-- Select Branch --</option>
                    @foreach($branches as $branch)
        ...
        <div>
            ...
            <select name="assigned_staff_id" class="w-full border rounded-lg p-2">
