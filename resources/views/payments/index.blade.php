<x-layouts.app>
    ...
    <a href="{{ route('payments.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded">+ New Payment</a>
        ...
        <tbody>
            @foreach($payments as $payment)
                <tr class="border-b">
                    ...
                    <td class="px-3 py-2">{{ $payment->customer->name ?? 'N/A' }}</td>
                    <td class="px-3 py-2">{{ $payment->amount }}</td>
                    <td class="px-3 py-2">{{ ucfirst($payment->method) }}</td>
                    <td class="px-3 py-2">{{ ucfirst($payment->status) }}</td>
                    <td class="px-3 py-2">
